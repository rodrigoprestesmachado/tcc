...
\OnehalfSpacing					% Espaçamento 1,5 (memoir/abntex2; IFRS/ABNT)
...
% Títulos de seção na mesma família do texto (Arial/Helvetica), em negrito
...
\begin{center}
    {\LARGE Título do Trabalho de Conclusão de Curso}\\[0.8cm]
    ...
    Coorientador(a): Nome do Coorientador\\[0.8cm]
    \textit{Instituto Federal de Educação, Ciência e Tecnologia do Rio
    Grande do Sul (IFRS)\\
    Campus Porto Alegre\\
...
parágrafo isolado, com fonte Arial, 10 pt, espaçamento simples, parágrafo
...
\textcolor{blue}{
Dicas: As considerações finais devem destacar como o trabalho contribui para o
